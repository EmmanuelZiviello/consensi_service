...
from F_taste_consensi.kafka.kafka_consumer import consume
from F_taste_consensi.db import set_DB_CONFIG,create_db

from F_taste_consensi.ma import ma

from F_taste_consensi.namespaces import paziente_ns
from F_taste_consensi.controllers.consensi_utente_controller import ConsensiUtente


from F_taste_consensi.utils.jwt_custom_decorators import NoAuthorizationException
...
def create_app():
    ...
    app.config.from_object('F_taste_consensi.config.DevelopmentConfig')
...
#    app.add_url_rule("/password_reset", view_func=TemplatePasswordChangerController.reindirizza, methods=['GET'])
 #   app.add_url_rule("/success", view_func=TemplatePasswordChangerController.successo, methods=['GET'])
  #  app.add_url_rule("/failure", view_func=TemplatePasswordChangerController.fallimento, methods=['GET'])
    ...
    def health_check():
        return {'message': 'API consensi è online'}, 200
